...
// Namespaces.
using global::Umbraco.Cms.Core.Models;
...
/// </remarks>
public class UmbracoCachingHandlers
{
    ...
    internal static void HandleChangedContent(IEnumerable<IContent> ids)
    {
    ...
    /// The invalidators.
    /// </returns>
    internal static List<ICacheByKeyInvalidator> GetKeyByParentInvalidators()
    {
    ...
    /// The invalidators.
    /// </returns>
    internal static List<ICacheByKeyInvalidator> GetKeyByPageInvalidators()
    {
    ...
    /// The invalidators.
    /// </returns>
    internal static List<ICacheInvalidator> GetPageInvalidatorsForAliases()
    {
    ...
    /// </remarks>
    internal static List<T> GetLiveValues<T>(ref List<WeakReference<T>> items) where T : class
    {
